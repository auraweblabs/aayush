          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="relative h-[420px] sm:h-[480px] rounded-3xl overflow-hidden shadow-2xl border border-[#e5ece7]">
              <Image
                ...
                alt="Artisanal Ayurvedic medicated massage oils and herbs at Aayur Touch Cameron Park"
                fill
            ...
            <div className="p-6 rounded-2xl bg-[#eedecd]/50 border border-[#eedecd] text-[#71462d]">
              ...
              <p className="mt-2 text-xs font-bold uppercase tracking-wider text-[#1b2d24]">
                — Aayur Touch Certified Practitioner, Cameron Park NSW
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            <div>
              ...
              <p className="text-sm sm:text-base text-[#345342] leading-relaxed">
                Every session in our Cameron Park sanctuary is a sacred sanctuary space where time slows down, your nervous system resets, and ancient herbal traditions work in unison.
              </p>
            </div>
