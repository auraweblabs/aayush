        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 truncate">
            ...
            <span className="font-medium text-cream-50 truncate">
              🌿 Certified Ayurvedic Massage at 19 Turnock Dr, Cameron Park NSW • Mon–Sat By Appointment
            </span>
          </div>
          <div className="hidden sm:flex items-center gap-4 text-xs text-[#ccdcd1] shrink-0">
            ...
            <span>•</span>
            <span>Serving Cameron Park & Newcastle</span>
          </div>
        </div>
      </div>
