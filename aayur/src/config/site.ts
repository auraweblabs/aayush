...
export const SITE_CONFIG = {
  ...
  location: "Rutherford, NSW 2320, Australia",
  serviceArea: "Rutherford, Maitland, Aberglasslyn, Farley, Telarah & Hunter Region",
  phone: "+61 451 205 328",
  phoneDisplay: "0451 205 328",
  email: "connect@aayurtouch.com.au",
  whatsappNumber: "61451205328",
  whatsappMessage: "Hello Aayur Touch, I would like to inquire about booking a personalized Ayurvedic massage session in Rutherford.",
  get whatsappUrl() {
  ...
  certifications: [
    ...
    {
      title: "Private Rutherford Sanctuary",
      desc: "A serene, quiet, and spotless retreat environment right here in Rutherford, NSW.",
    },
  ],
  services: [
    {
  ...
  faqs: [
    {
      question: "Why choose Ayurvedic massage in Rutherford, NSW?",
      answer: "Ayurvedic massage at Aayur Touch goes beyond standard muscle manipulation. It uses personalised, certified techniques to balance your body's vital energy (Doshas), offering both physical relief and mental clarity right here in Rutherford. Unlike generic spa sessions, every treatment uses warm, herb-infused organic medicated oils customized for your individual constitution and physical condition.",
    },
    {
    ...
    },
    {
      ...
      answer: "Aayur Touch is located in a quiet, accessible sanctuary setting in Rutherford, NSW 2320, serving clients from Rutherford, Maitland, Aberglasslyn, Farley, Telarah, and the greater Hunter Valley. Free, convenient private parking is available directly on-site.",
    },
  ],
};
